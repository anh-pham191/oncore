...
$deal['user_id'] = "3089717"; //assign to Dan V
$contact['owner_id'] = "3089717";

$deal['pipeline_id'] = "35"; // 1 - Refresh NZ; 3 - Zones NZ; 4 - Refresh Oz; 5 - Refresh UK; 6 - Refresh US; 7 - Refresh Other; 35 - Oncore
$deal['title'] = $contact['name'] . " Deal";
$deal['03197a58402293106dd45764ea9d3b6d45c936d5'] = "Oncore Website"; //Lead source
...
if (isset($medium) && $medium != "") {
    $deal['c56896cceb314c5c96bd7d77ac59585fc15cce15'] = $medium; //Referral medium
}
// Master Franchise form
...
//    $deal['pipeline_id'] = "35";
//    if (isset($enquiry) && $enquiry != "") {
//        $deal['46a3299d657baba2a9de0731eb7ae060c7f901d9'] = "[Oncore Master Franchies Enquiry] ".$enquiry; //Enquiry
//    }
//}
